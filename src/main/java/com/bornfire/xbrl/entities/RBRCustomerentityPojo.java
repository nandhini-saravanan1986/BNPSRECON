...
public class RBRCustomerentityPojo {
	...
	private String cutomer_data;
	private String security_date;
	private String provision_data;
	private String facility_data;
	private String overall_data;
	private String partner_data;
	private String legal_case_data;
	private String investment_data;
	...
	public String getCutomer_data() {
		return cutomer_data;
	}
	public void setCutomer_data(String cutomer_data) {
		this.cutomer_data = cutomer_data;
	}
	...
	public String getProvision_data() {
		return provision_data;
	}
	public void setProvision_data(String provision_data) {
		this.provision_data = provision_data;
	}
	public String getFacility_data() {
		return facility_data;
	}
	public void setFacility_data(String facility_data) {
		this.facility_data = facility_data;
	}
	public String getOverall_data() {
		return overall_data;
	}
	public void setOverall_data(String overall_data) {
		this.overall_data = overall_data;
	}
	public String getPartner_data() {
		return partner_data;
	}
	public void setPartner_data(String partner_data) {
		this.partner_data = partner_data;
	}
	public String getLegal_case_data() {
		return legal_case_data;
	}
	public void setLegal_case_data(String legal_case_data) {
		this.legal_case_data = legal_case_data;
	}
	...
	public RBRCustomerentityPojo(String cust_id, String operation, String bank_code, String cin, String branch_code,
			String csno, String srl_no, String cif_no, String remarks, String caname, String cename, String type_code,
			String sub_bor_type, String cus_res, String borrower_subsidiary, String group_up, String group_ip,
			String lei, String cus_dom, String eco_sec, Date est_date, String emi_est, String lic_id, Date exp_lic,
			String emi_lic, String telephone, Date dob, String eid, Date exp_emi_id, String passport, Date exp_passport,
			BigDecimal capital_annual_income, BigDecimal turnover_operating_income, String auditor, String employer,
			Date date_of_audited_fs, BigDecimal no_of_employees, String gender, String reserve_line_1,
			...
			String auth_flg, String modify_flg, String del_flg, Date acct_opn_date, String cutomer_data,
			String security_date, String provision_data, String facility_data, String overall_data, String partner_data,
			String legal_case_data, String investment_data) {
		super();
		this.cust_id = cust_id;
		this.operation = operation;
		this.bank_code = bank_code;
