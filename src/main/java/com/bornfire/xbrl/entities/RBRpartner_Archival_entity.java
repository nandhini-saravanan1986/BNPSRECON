...
@Entity
@Table(name = "ARCHIVAL_PARTNER_SHAREHOLDER_DATA")
public class RBRpartner_Archival_entity {
	...
	public RBRpartner_Archival_entity(String operation, String acid, String cust_id, String bankcode, String srl_no,
	...
	public RBRpartner_Archival_entity(RBRShareHolder_Entity cud) {
		this.operation = cud.getOperation();
		this.acid = cud.getAcid();
		this.cust_id = cud.getCust_id();
		this.bankcode = cud.getBankcode();
		this.srl_no = cud.getSrl_no();
		this.cin = cud.getCin();
		this.csno = cud.getCsno();
		this.part_shar_rec_id = cud.getPart_shar_rec_id();
		this.part_shar_type = cud.getPart_shar_type();
		this.p_s_aname = cud.getP_s_aname();
		this.p_s_ename = cud.getP_s_ename();
		this.p_s_cin = cud.getP_s_cin();
		this.p_s_res = cud.getP_s_res();
		this.p_s_share_percentage = cud.getP_s_share_percentage();
		this.p_s_legal_status = cud.getP_s_legal_status();
		this.p_s_emi_id = cud.getP_s_emi_id();
		this.p_s_exp_emi_id = cud.getP_s_exp_emi_id();
		this.p_s_passport_no = cud.getP_s_passport_no();
		this.p_s_exp_passport = cud.getP_s_exp_passport();
		this.p_s_nat_code = cud.getP_s_nat_code();
		this.p_s_trade_license_no = cud.getP_s_trade_license_no();
		this.p_s_place_of_issuing_tl = cud.getP_s_place_of_issuing_tl();
		this.p_s_lei = cud.getP_s_lei();
		this.p_s_lei_number = cud.getP_s_lei_number();
		...
		this.net_worth_p_s = cud.getNet_worth_p_s();
	...
	public RBRpartner_Archival_entity() {
		super();
