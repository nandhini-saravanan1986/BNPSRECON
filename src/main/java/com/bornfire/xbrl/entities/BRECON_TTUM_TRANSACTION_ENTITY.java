...
@Entity
@Table(name="BRECON_TTUM_TRANSACTION")
public class BRECON_TTUM_TRANSACTION_ENTITY {
	...
	public String toString() {
		return "BRECON_TTUM_TRANSACTION_ENTITY [acid=" + acid + ", amt_reservation_ind=" + amt_reservation_ind
				+ ", bank_code=" + bank_code + ", bank_id=" + bank_id + ", bkdt_tran_flg=" + bkdt_tran_flg
				+ ", br_code=" + br_code + ", create_time=" + create_time + ", create_user=" + create_user
				+ ", crncy_code=" + crncy_code + ", crncy_hol_chk_done_flg=" + crncy_hol_chk_done_flg + ", cust_id="
				+ cust_id + ", del_flg=" + del_flg + ", del_memo_pad=" + del_memo_pad + ", dth_init_sol_id="
				+ dth_init_sol_id + ", eabfab_upd_flg=" + eabfab_upd_flg + ", entity_flg=" + entity_flg
				+ ", entry_date=" + entry_date + ", entry_user_id=" + entry_user_id + ", fx_tran_amt=" + fx_tran_amt
				+ ", gl_date=" + gl_date + ", gl_segment_string=" + gl_segment_string + ", gl_sub_head_code="
				+ gl_sub_head_code + ", gst_upd_flg=" + gst_upd_flg + ", impl_cash_part_tran_flg="
				+ impl_cash_part_tran_flg + ", instrmnt_alpha=" + instrmnt_alpha + ", instrmnt_date=" + instrmnt_date
				+ ", instrmnt_num=" + instrmnt_num + ", instrmnt_type=" + instrmnt_type + ", iso_flg=" + iso_flg
				+ ", lchg_time=" + lchg_time + ", lchg_user_id=" + lchg_user_id + ", lift_lien_flg=" + lift_lien_flg
				+ ", modify_flg=" + modify_flg + ", modify_time=" + modify_time + ", modify_user=" + modify_user
				+ ", module_id=" + module_id + ", mud_pool_bal_build_flg=" + mud_pool_bal_build_flg
				+ ", navigation_flg=" + navigation_flg + ", party_code=" + party_code + ", part_tran_srl_num="
				+ part_tran_srl_num + ", part_tran_type=" + part_tran_type + ", principal_portion_amt="
				+ principal_portion_amt + ", prnt_advc_ind=" + prnt_advc_ind + ", proxy_acid=" + proxy_acid
				+ ", proxy_post_ind=" + proxy_post_ind + ", pr_srl_num=" + pr_srl_num + ", pstd_date=" + pstd_date
				+ ", pstd_flg=" + pstd_flg + ", pstd_user_id=" + pstd_user_id + ", ptran_chrg_exists_flg="
				+ ptran_chrg_exists_flg + ", pttm_event_type=" + pttm_event_type + ", rate=" + rate + ", rate_code="
				+ rate_code + ", rcre_time=" + rcre_time + ", rcre_user_id=" + rcre_user_id + ", recon_date="
				+ recon_date + ", recon_flag=" + recon_flag + ", referral_id=" + referral_id + ", ref_amt=" + ref_amt
				+ ", ref_crncy_code=" + ref_crncy_code + ", ref_num=" + ref_num + ", regularization_amt="
				+ regularization_amt + ", report_date=" + report_date + ", report_from_date=" + report_from_date
				+ ", report_to_date=" + report_to_date + ", reservation_amt=" + reservation_amt
				+ ", restrict_modify_ind=" + restrict_modify_ind + ", reversal_date=" + reversal_date
				+ ", reversal_value_date=" + reversal_value_date + ", rpt_code=" + rpt_code + ", serial_num="
				+ serial_num + ", si_org_exec_date=" + si_org_exec_date + ", si_srl_num=" + si_srl_num + ", sol_id="
				+ sol_id + ", srlno=" + srlno + ", svs_tran_id=" + svs_tran_id + ", sys_part_tran_code="
				+ sys_part_tran_code + ", tf_entity_sol_id=" + tf_entity_sol_id + ", tod_entity_id=" + tod_entity_id
				+ ", tod_entity_type=" + tod_entity_type + ", tran_amt=" + tran_amt + ", tran_crncy_code="
				+ tran_crncy_code + ", tran_date=" + tran_date + ", tran_free_code1=" + tran_free_code1
				+ ", tran_free_code2=" + tran_free_code2 + ", tran_id=" + tran_id + ", tran_particular="
				+ tran_particular + ", tran_particular_2=" + tran_particular_2 + ", tran_particular_code="
				+ tran_particular_code + ", tran_rmks=" + tran_rmks + ", tran_sub_type=" + tran_sub_type
				+ ", tran_type=" + tran_type + ", trea_rate=" + trea_rate + ", trea_ref_num=" + trea_ref_num
				+ ", tr_status=" + tr_status + ", ts_cnt=" + ts_cnt + ", uad_module_id=" + uad_module_id
				+ ", uad_module_key=" + uad_module_key + ", user_part_tran_code=" + user_part_tran_code
				+ ", value_date=" + value_date + ", verify_time=" + verify_time + ", verify_user=" + verify_user
				+ ", vfd_date=" + vfd_date + ", vfd_user_id=" + vfd_user_id + ", voucher_print_flg=" + voucher_print_flg
				+ ", account_no=" + account_no + ", canonicalizationmethod_algorithm="
				+ canonicalizationmethod_algorithm + ", digestmethod_algorithm=" + digestmethod_algorithm
				+ ", grphdr_bank_identifier_code=" + grphdr_bank_identifier_code + ", grphdr_creation_date_time="
				+ grphdr_creation_date_time + ", grphdr_last_page_indicator=" + grphdr_last_page_indicator
				+ ", grphdr_message_identifier=" + grphdr_message_identifier + ", grphdr_name=" + grphdr_name
				+ ", grphdr_page_number=" + grphdr_page_number + ", ntry_account_servicer_reference="
				+ ntry_account_servicer_reference + ", ntry_amount_currency=" + ntry_amount_currency
				+ ", ntry_booking_date=" + ntry_booking_date + ", ntry_booking_date_time=" + ntry_booking_date_time
				+ ", ntry_brch_cdtdbtint=" + ntry_brch_cdtdbtint + ", ntry_btch_currency=" + ntry_btch_currency
				+ ", ntry_btch_msg_id=" + ntry_btch_msg_id + ", ntry_btch_numoftxs=" + ntry_btch_numoftxs
				+ ", ntry_btch_ttlamt=" + ntry_btch_ttlamt + ", ntry_cdtragt_bicfi_credit=" + ntry_cdtragt_bicfi_credit
				+ ", ntry_code=" + ntry_code + ", ntry_credit_debit_indicator=" + ntry_credit_debit_indicator
				+ ", ntry_dbtragt_bicfi_debit=" + ntry_dbtragt_bicfi_debit + ", ntry_entry_reference="
				+ ntry_entry_reference + ", ntry_fininstnid_bicfi=" + ntry_fininstnid_bicfi
				+ ", ntry_instructed_amount=" + ntry_instructed_amount + ", ntry_proprietary_code="
				+ ntry_proprietary_code + ", ntry_refs_account_servicer_reference="
				+ ntry_refs_account_servicer_reference + ", ntry_refs_clearing_system_reference="
				+ ntry_refs_clearing_system_reference + ", ntry_refs_end_to_end_identification="
				+ ntry_refs_end_to_end_identification + ", ntry_refs_instruction_id=" + ntry_refs_instruction_id
				+ ", ntry_refs_message_identifier=" + ntry_refs_message_identifier + ", ntry_refs_pmtinfid="
				+ ntry_refs_pmtinfid + ", ntry_refs_transaction_id=" + ntry_refs_transaction_id + ", ntry_refs_uetr="
				+ ntry_refs_uetr + ", ntry_transaction_amount=" + ntry_transaction_amount
				+ ", ntry_txdtls_amount_currency=" + ntry_txdtls_amount_currency
				+ ", ntry_txdtls_credit_debit_indicator=" + ntry_txdtls_credit_debit_indicator + ", ntry_value_date="
				+ ntry_value_date + ", ntry_value_date_time=" + ntry_value_date_time + ", report_name=" + report_name
				+ ", signaturemethod_algorithm=" + signaturemethod_algorithm + ", signature_keyinfo_x509_certificate="
				+ signature_keyinfo_x509_certificate + ", signature_keyinfo_x509_subject_name="
				+ signature_keyinfo_x509_subject_name + ", signature_signedinfo_digest_value="
				+ signature_signedinfo_digest_value + ", signature_signedinfo_signature_value="
				+ signature_signedinfo_signature_value + ", stmt_account_identifier=" + stmt_account_identifier
				+ ", stmt_bal1_amount=" + stmt_bal1_amount + ", stmt_bal1_code_or_proprietary="
				+ stmt_bal1_code_or_proprietary + ", stmt_bal1_credit_debit_indicator="
				+ stmt_bal1_credit_debit_indicator + ", stmt_bal1_date=" + stmt_bal1_date + ", stmt_bal1_date_time="
				+ stmt_bal1_date_time + ", stmt_bal_amount=" + stmt_bal_amount + ", stmt_bal_code_or_proprietary="
				+ stmt_bal_code_or_proprietary + ", stmt_bal_credit_debit_indicator=" + stmt_bal_credit_debit_indicator
				+ ", stmt_bal_date=" + stmt_bal_date + ", stmt_bal_date_time=" + stmt_bal_date_time
				+ ", stmt_creation_date_time=" + stmt_creation_date_time + ", stmt_electronic_sequence_number="
				+ stmt_electronic_sequence_number + ", stmt_from_date_time=" + stmt_from_date_time
				+ ", stmt_related_account_identifier=" + stmt_related_account_identifier
				+ ", stmt_statement_identifier=" + stmt_statement_identifier + ", stmt_to_date_time="
				+ stmt_to_date_time + ", transaction_currency=" + transaction_currency + ", transform_algorithm="
				+ transform_algorithm + ", txssummry_amount=" + txssummry_amount + ", txssummry_credit_debit_indicator="
				+ txssummry_credit_debit_indicator + ", txssummry_credit_number_of_entries="
				+ txssummry_credit_number_of_entries + ", txssummry_credit_sum=" + txssummry_credit_sum
				+ ", txssummry_debit_number_of_entries=" + txssummry_debit_number_of_entries + ", txssummry_debit_sum="
				+ txssummry_debit_sum + ", txssummry_number_of_entries=" + txssummry_number_of_entries
				+ ", txssummry_sum=" + txssummry_sum + "]";
	}
	public BRECON_TTUM_TRANSACTION_ENTITY(String acid, String amt_reservation_ind, String bank_code, String bank_id,
			String bkdt_tran_flg, String br_code, Date create_time, String create_user, String crncy_code,
			String crncy_hol_chk_done_flg, String cust_id, String del_flg, String del_memo_pad, String dth_init_sol_id,
			String eabfab_upd_flg, String entity_flg, Date entry_date, String entry_user_id, BigDecimal fx_tran_amt,
			Date gl_date, String gl_segment_string, String gl_sub_head_code, String gst_upd_flg,
			String impl_cash_part_tran_flg, String instrmnt_alpha, Date instrmnt_date, String instrmnt_num,
			String instrmnt_type, String iso_flg, Date lchg_time, String lchg_user_id, String lift_lien_flg,
			String modify_flg, Date modify_time, String modify_user, String module_id, String mud_pool_bal_build_flg,
			String navigation_flg, String party_code, String part_tran_srl_num, String part_tran_type,
			...
			String ref_num, BigDecimal regularization_amt, Date report_date, Date report_from_date, Date report_to_date,
			BigDecimal reservation_amt, String restrict_modify_ind, Date reversal_date, Date reversal_value_date,
			String rpt_code, String serial_num, Date si_org_exec_date, String si_srl_num, String sol_id, String srlno,
			String svs_tran_id, String sys_part_tran_code, String tf_entity_sol_id, String tod_entity_id,
			String tod_entity_type, BigDecimal tran_amt, String tran_crncy_code, Date tran_date, String tran_free_code1,
			String tran_free_code2, String tran_id, String tran_particular, String tran_particular_2,
			String tran_particular_code, String tran_rmks, String tran_sub_type, String tran_type, BigDecimal trea_rate,
			String trea_ref_num, String tr_status, BigDecimal ts_cnt, String uad_module_id, String uad_module_key,
			String user_part_tran_code, Date value_date, Date verify_time, String verify_user, Date vfd_date,
			String vfd_user_id, String voucher_print_flg, String account_no, String canonicalizationmethod_algorithm,
			String digestmethod_algorithm, String grphdr_bank_identifier_code, Date grphdr_creation_date_time,
			String grphdr_last_page_indicator, String grphdr_message_identifier, String grphdr_name,
			BigDecimal grphdr_page_number, String ntry_account_servicer_reference, BigDecimal ntry_amount_currency,
			Date ntry_booking_date, Date ntry_booking_date_time, String ntry_brch_cdtdbtint, String ntry_btch_currency,
			String ntry_btch_msg_id, BigDecimal ntry_btch_numoftxs, BigDecimal ntry_btch_ttlamt,
			String ntry_cdtragt_bicfi_credit, String ntry_code, String ntry_credit_debit_indicator,
			String ntry_dbtragt_bicfi_debit, String ntry_entry_reference, String ntry_fininstnid_bicfi,
			BigDecimal ntry_instructed_amount, String ntry_proprietary_code,
			String ntry_refs_account_servicer_reference, String ntry_refs_clearing_system_reference,
			String ntry_refs_end_to_end_identification, String ntry_refs_instruction_id,
			String ntry_refs_message_identifier, String ntry_refs_pmtinfid, String ntry_refs_transaction_id,
			String ntry_refs_uetr, BigDecimal ntry_transaction_amount, BigDecimal ntry_txdtls_amount_currency,
			String ntry_txdtls_credit_debit_indicator, Date ntry_value_date, String ntry_value_date_time,
			String report_name, String signaturemethod_algorithm, String signature_keyinfo_x509_certificate,
			String signature_keyinfo_x509_subject_name, String signature_signedinfo_digest_value,
			String signature_signedinfo_signature_value, String stmt_account_identifier, BigDecimal stmt_bal1_amount,
			String stmt_bal1_code_or_proprietary, String stmt_bal1_credit_debit_indicator, Date stmt_bal1_date,
			Date stmt_bal1_date_time, BigDecimal stmt_bal_amount, String stmt_bal_code_or_proprietary,
			String stmt_bal_credit_debit_indicator, Date stmt_bal_date, Date stmt_bal_date_time,
			Date stmt_creation_date_time, BigDecimal stmt_electronic_sequence_number, Date stmt_from_date_time,
			String stmt_related_account_identifier, String stmt_statement_identifier, Date stmt_to_date_time,
			String transaction_currency, String transform_algorithm, BigDecimal txssummry_amount,
			String txssummry_credit_debit_indicator, BigDecimal txssummry_credit_number_of_entries,
			BigDecimal txssummry_credit_sum, BigDecimal txssummry_debit_number_of_entries,
			BigDecimal txssummry_debit_sum, BigDecimal txssummry_number_of_entries, BigDecimal txssummry_sum) {
		super();
		this.acid = acid;
		this.amt_reservation_ind = amt_reservation_ind;
		this.bank_code = bank_code;
	...
	public BRECON_TTUM_TRANSACTION_ENTITY() {
		super();
