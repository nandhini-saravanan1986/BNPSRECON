...
public class Facitlity_Entity {
	...
	public Facitlity_Entity(String operation, String acid, String cust_id, String bank_code, String srl_no, String cin,
			String csno, String product, String fac_id, String fac_class, BigDecimal limit_funded, BigDecimal os_funded,
			BigDecimal limit_unfunded, BigDecimal limit_total, BigDecimal os_unfunded_before_ccf,
