...
@Entity
@Table(name = "customer_data1")
public class RBRcustomer_entity {
	...
	public RBRcustomer_entity(String cust_id, String operation, String bank_code, String cin, String branch_code,
