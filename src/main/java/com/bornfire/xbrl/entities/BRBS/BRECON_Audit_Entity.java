...
@Entity
@Table(name = "BRECON_AUDIT_TABLE")
public class BRECON_Audit_Entity {
	@Id
	...
	public BRECON_Audit_Entity(String audit_ref_no, Date audit_date, String audit_table, String audit_screen,
