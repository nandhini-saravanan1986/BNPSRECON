...
@Entity
@Table(name="BRECON_AANI_PAYMENT_DUPLICATE_RECORDS_UPLOAD")
public class Brecon_aani_payment_duplicate_entity {
	...
	public Brecon_aani_payment_duplicate_entity(String account_no, String grphdr_message_identifier,
			...
			String ntry_refs_account_servicer_reference, String ntry_refs_instruction_id,
			...
			String report_name, String ntry_btch_msg_id, BigDecimal ntry_btch_numoftxs, BigDecimal ntry_btch_ttlamt,
			String ntry_brch_cdtdbtint, String ntry_refs_pmtinfid, String ntry_refs_uetr, String create_user,
			Date create_time, String modify_user, Date modify_time, String verify_user, Date verify_time,
			String entity_flg, String modify_flg, String del_flg, String srlno, Date report_from_date,
			Date report_to_date, Date report_date, Date recon_date, String recon_flag, String ntry_btch_currency,
	...
	public String toString() {
		return "Brecon_aani_payment_duplicate_entity [account_no=" + account_no + ", grphdr_message_identifier="
				+ grphdr_message_identifier + ", grphdr_creation_date_time=" + grphdr_creation_date_time
				+ ", grphdr_name=" + grphdr_name + ", grphdr_bank_identifier_code=" + grphdr_bank_identifier_code
				+ ", grphdr_page_number=" + grphdr_page_number + ", grphdr_last_page_indicator="
				+ grphdr_last_page_indicator + ", stmt_statement_identifier=" + stmt_statement_identifier
				+ ", stmt_electronic_sequence_number=" + stmt_electronic_sequence_number + ", stmt_creation_date_time="
				+ stmt_creation_date_time + ", stmt_from_date_time=" + stmt_from_date_time + ", stmt_to_date_time="
				+ stmt_to_date_time + ", stmt_account_identifier=" + stmt_account_identifier
				+ ", stmt_related_account_identifier=" + stmt_related_account_identifier
				+ ", stmt_bal_code_or_proprietary=" + stmt_bal_code_or_proprietary + ", stmt_bal_amount="
				+ stmt_bal_amount + ", stmt_bal_credit_debit_indicator=" + stmt_bal_credit_debit_indicator
				+ ", stmt_bal_date=" + stmt_bal_date + ", stmt_bal_date_time=" + stmt_bal_date_time
				+ ", txssummry_number_of_entries=" + txssummry_number_of_entries + ", txssummry_sum=" + txssummry_sum
				+ ", txssummry_amount=" + txssummry_amount + ", txssummry_credit_debit_indicator="
				...
				+ txssummry_debit_sum + ", ntry_entry_reference=" + ntry_entry_reference + ", ntry_amount_currency="
				+ ntry_amount_currency + ", ntry_credit_debit_indicator=" + ntry_credit_debit_indicator + ", ntry_code="
				+ ntry_code + ", ntry_booking_date=" + ntry_booking_date + ", ntry_booking_date_time="
				+ ntry_booking_date_time + ", ntry_value_date=" + ntry_value_date + ", ntry_value_date_time="
				+ ntry_value_date_time + ", ntry_account_servicer_reference=" + ntry_account_servicer_reference
				+ ", ntry_proprietary_code=" + ntry_proprietary_code + ", ntry_instructed_amount="
				+ ntry_instructed_amount + ", ntry_transaction_amount=" + ntry_transaction_amount
				+ ", ntry_refs_message_identifier=" + ntry_refs_message_identifier
				+ ", ntry_refs_account_servicer_reference=" + ntry_refs_account_servicer_reference
				+ ", ntry_refs_instruction_id=" + ntry_refs_instruction_id + ", ntry_refs_end_to_end_identification="
				+ ntry_refs_end_to_end_identification + ", ntry_refs_transaction_id=" + ntry_refs_transaction_id
				+ ", ntry_refs_clearing_system_reference=" + ntry_refs_clearing_system_reference
				+ ", ntry_txdtls_amount_currency=" + ntry_txdtls_amount_currency
				+ ", ntry_txdtls_credit_debit_indicator=" + ntry_txdtls_credit_debit_indicator
				+ ", ntry_fininstnid_bicfi=" + ntry_fininstnid_bicfi + ", ntry_dbtragt_bicfi_debit="
				+ ntry_dbtragt_bicfi_debit + ", ntry_cdtragt_bicfi_credit=" + ntry_cdtragt_bicfi_credit
				+ ", signature_signedinfo_digest_value=" + signature_signedinfo_digest_value
				+ ", signature_signedinfo_signature_value=" + signature_signedinfo_signature_value
				+ ", signature_keyinfo_x509_subject_name=" + signature_keyinfo_x509_subject_name
				+ ", signature_keyinfo_x509_certificate=" + signature_keyinfo_x509_certificate
				+ ", canonicalizationmethod_algorithm=" + canonicalizationmethod_algorithm
				+ ", signaturemethod_algorithm=" + signaturemethod_algorithm + ", transform_algorithm="
				+ transform_algorithm + ", digestmethod_algorithm=" + digestmethod_algorithm + ", report_name="
				+ report_name + ", ntry_btch_msg_id=" + ntry_btch_msg_id + ", ntry_btch_numoftxs=" + ntry_btch_numoftxs
				+ ", ntry_btch_ttlamt=" + ntry_btch_ttlamt + ", ntry_brch_cdtdbtint=" + ntry_brch_cdtdbtint
				+ ", ntry_refs_pmtinfid=" + ntry_refs_pmtinfid + ", ntry_refs_uetr=" + ntry_refs_uetr + ", create_user="
				...
				+ entity_flg + ", modify_flg=" + modify_flg + ", del_flg=" + del_flg + ", srlno=" + srlno
				+ ", report_from_date=" + report_from_date + ", report_to_date=" + report_to_date + ", report_date="
				+ report_date + ", recon_date=" + recon_date + ", recon_flag=" + recon_flag + ", ntry_btch_currency="
				+ ntry_btch_currency + ", stmt_bal1_code_or_proprietary=" + stmt_bal1_code_or_proprietary
				+ ", stmt_bal1_amount=" + stmt_bal1_amount + ", stmt_bal1_credit_debit_indicator="
				+ stmt_bal1_credit_debit_indicator + ", stmt_bal1_date=" + stmt_bal1_date + ", stmt_bal1_date_time="
				+ stmt_bal1_date_time + ", transaction_currency=" + transaction_currency + "]";
	}
	public Brecon_aani_payment_duplicate_entity() {
		super();
